...
#>past the url you copied from repositroy> enter>click the folder you want the reposity contained in> then select as repository destination
#then can use commands to push and pull things to the main repository hosted online


#if I wanted to upload this file from vs code to github: open terminal: view>terminal>
